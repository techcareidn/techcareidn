  ...
  return (
    <>
      <style jsx global>{`
        ...
        .tc-hero-visual-device{position:absolute; inset:18% 15%; border-radius:22px; background:rgba(255,255,255,.82); border:1px solid rgba(255,255,255,.72); box-shadow:0 22px 45px rgba(13,39,69,.16); display:flex; align-items:center; justify-content:center; font-size:68px;}
        ...
        .tc-app-grid-section{padding:76px 0 10px;}.tc-app-grid{display:grid; grid-template-columns:repeat(4,1fr); gap:20px;}.tc-app-card{background:#fff; border:1px solid var(--tc-line); border-radius:18px; padding:30px 24px; transition:transform .2s ease, box-shadow .2s ease;}.tc-app-card:hover{transform:translateY(-4px); box-shadow:0 18px 34px -20px rgba(13,39,69,.25);}.tc-app-badge{width:52px; height:52px; border-radius:16px; display:flex; align-items:center; justify-content:center; margin-bottom:24px; font-size:24px;}.tc-app-card h4{font-size:20px; margin-bottom:8px;}.tc-app-card span{font-size:14px; color:var(--tc-ink-soft); display:block;}
        .tc-cta-banner-wrap{padding:56px 0 12px;}.tc-cta-banner{background:linear-gradient(135deg,var(--tc-navy),var(--tc-blue)); color:#fff; border-radius:24px; padding:28px 32px; display:flex; align-items:center; gap:20px; box-shadow:0 22px 45px -28px rgba(13,39,69,.65);}.tc-cta-icon{width:52px; height:52px; border-radius:16px; background:rgba(255,255,255,.14); display:flex; align-items:center; justify-content:center; flex-shrink:0;}.tc-cta-banner h4{color:#fff; font-size:22px; margin-bottom:5px;}.tc-cta-banner p{color:rgba(255,255,255,.76); font-size:14.5px; max-width:720px; margin:0;}.tc-cta-arrow{margin-left:auto; width:38px; height:38px; border-radius:50%; background:var(--tc-gold); display:flex; align-items:center; justify-content:center; flex-shrink:0;}
        ...
        .tc-product-section{padding:72px 0;}.tc-product-grid{display:grid; grid-template-columns:1.1fr .9fr; gap:22px; align-items:stretch;}.tc-feature-card{background:#fff; border:1px solid var(--tc-line); border-radius:24px; padding:34px; display:grid; grid-template-columns:1fr .8fr; gap:28px; align-items:center;}.tc-feature-card h3{font-size:32px; margin:12px 0 14px;}.tc-feature-card p{color:var(--tc-ink-soft); margin:0 0 22px;}.tc-feature-visual{min-height:250px; border-radius:20px; background:linear-gradient(135deg,var(--tc-sky-pale),var(--tc-gold-pale)); position:relative; overflow:hidden;}.tc-feature-visual::after{content:'💻'; position:absolute; inset:0; display:flex; align-items:center; justify-content:center; font-size:92px; filter:drop-shadow(0 20px 25px rgba(13,39,69,.18));}.tc-mini-list{display:grid; gap:16px;}.tc-mini-card{background:#fff; border:1px solid var(--tc-line); border-radius:20px; padding:22px; display:flex; gap:14px; align-items:flex-start;}.tc-mini-icon{width:44px; height:44px; flex:none; border-radius:14px; display:flex; align-items:center; justify-content:center; background:var(--tc-gold-pale); color:var(--tc-navy); font-size:22px;}.tc-mini-card h4{font-size:18px; margin-bottom:5px;}.tc-mini-card p{font-size:13.5px; color:var(--tc-ink-soft); margin:0;}
      ...
      <div className="tc-page">
        ...
        <section className="tc-product-section"><div className="tc-wrap tc-product-grid"><div className="tc-feature-card"><div><div className="tc-eyebrow">Marketplace</div><h3>Listing perangkat dengan rasa media komunitas</h3><p>Tampilan mengikuti struktur Pelita Anak: editorial, bersih, kredibel, dan mudah dibaca. Cocok untuk membangun rasa percaya sebelum user mengajukan peminjaman.</p><Link className="tc-btn tc-btn-primary" href="/dashboard">Tambah perangkat</Link></div><div className="tc-feature-visual" /></div><div className="tc-mini-list"><div className="tc-mini-card"><div className="tc-mini-icon">📍</div><div><h4>Lokasi jelas</h4><p>Simpan lokasi sebagai alamat atau koordinat untuk pencarian terdekat.</p></div></div><div className="tc-mini-card"><div className="tc-mini-icon">🪪</div><div><h4>Profil & KTM</h4><p>Upload foto profil dan KTM via Supabase Storage untuk proses verifikasi.</p></div></div><div className="tc-mini-card"><div className="tc-mini-icon">🔔</div><div><h4>Notifikasi</h4><p>Route WhatsApp sudah disiapkan untuk update status pengajuan.</p></div></div></div></div></section>
